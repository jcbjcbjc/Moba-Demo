    ...
    execute: function () {
      ...
      _export("UIPowerRanking", UIPowerRanking = (_dec = ccclass('UIPowerRanking'), _dec2 = property(_crd && List === void 0 ? (_reportPossibleCrUseOfList({
        ...
        */
        ...
        InitCombatPowerRanking() {
          var _this = this;

          return _asyncToGenerator(function* () {
            _this.userList = [];
            var response = (_crd && CombatPowerRankingManager === void 0 ? (_reportPossibleCrUseOfCombatPowerRankingManager({
              error: Error()
            ...
            if (response) {
              ...
              _this.myPowerRankingLabel.string = response.myRanking == -1 ? '你当前未上榜' : '你当前排在' + response.myRanking + '位';
            }

            _this.powerRankingList.numItems = _this.userList.length;
          })();
        }
        ...
        */
        ...
        OnPowerRankingListRender(node, index) {
          var uiPowerRankingItem = node.getComponent(_crd && UIPowerRankingItem === void 0 ? (_reportPossibleCrUseOfUIPowerRankingItem({
            error: Error()
