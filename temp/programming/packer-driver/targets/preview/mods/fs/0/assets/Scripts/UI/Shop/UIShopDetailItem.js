System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Label, Sprite, proto, EventManager, LoadResUtil, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _temp, _crd, ccclass, property, NItem, Result, UIShopDetailItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dbb45ZYVBtHjIM2X0nE5wcE", "UIShopDetailItem", undefined);
      ...
      _export("UIShopDetailItem", UIShopDetailItem = (_dec = ccclass('UIShopDetailItem'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Sprite), _dec(_class = (_class2 = (_temp = class UIShopDetailItem extends Component {
        constructor() {
          super(...arguments);
        ...
        SetItemInfo(itemDefine, shopItemDefine, index, uiShop) {
          var _this = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.uiShop = uiShop;
            _this.itemDefine = itemDefine;
            _this.shopItemDefine = shopItemDefine;
            ...
            _this.nameLabel.string = _this.itemDefine.Name;
            _this.countLabel.string = '数量：' + _this.shopItemDefine.Count;
            _this.priceLabel.string = '价格：' + _this.shopItemDefine.Price;
            _this.descLabel.string = '描述：' + _this.itemDefine.Description;
          })();
        }
...
//# sourceMappingURL=UIShopDetailItem.js.map