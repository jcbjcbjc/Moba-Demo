System.register(["@protobufjs/aspromise", "@protobufjs/base64", "@protobufjs/eventemitter", "@protobufjs/float", "@protobufjs/inquire", "@protobufjs/utf8", "@protobufjs/pool", "__unresolved_0", "__unresolved_1"], function (_export, _context) {
  "use strict";

  var _req, _req2, _req3, _req4, _req5, _req6, _req7, _req8, _loader, _cjsExports, __cjsMetaURL;

  _export("default", void 0);

  return {
    setters: [function (_protobufjsAspromise) {
      _req = _protobufjsAspromise.__cjsMetaURL;
    }, function (_protobufjsBase) {
      _req2 = _protobufjsBase.__cjsMetaURL;
    }, function (_protobufjsEventemitter) {
      _req3 = _protobufjsEventemitter.__cjsMetaURL;
    }, function (_protobufjsFloat) {
      _req4 = _protobufjsFloat.__cjsMetaURL;
    }, function (_protobufjsInquire) {
      _req5 = _protobufjsInquire.__cjsMetaURL;
    }, function (_protobufjsUtf) {
      _req6 = _protobufjsUtf.__cjsMetaURL;
    }, function (_protobufjsPool) {
      _req7 = _protobufjsPool.__cjsMetaURL;
    }, function (_unresolved_) {
      _req8 = _unresolved_.__cjsMetaURL;
    ...
    execute: function () {
      _loader.define(_context.meta.url, function (exports, _require, module, __filename, __dirname) {
        var require = _loader.createRequireWithReqMap({
          ...
          "@protobufjs/base64": _req2,
          "@protobufjs/eventemitter": _req3,
          "@protobufjs/float": _req4,
          "@protobufjs/inquire": _req5,
          "@protobufjs/utf8": _req6,
          "@protobufjs/pool": _req7,
          "./longbits": _req8
        }, _require);
