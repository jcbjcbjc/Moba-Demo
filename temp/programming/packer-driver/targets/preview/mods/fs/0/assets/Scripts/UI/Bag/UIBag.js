  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIBag", UIBag = (_dec = ccclass('UIBag'), _dec2 = property(_crd && List === void 0 ? (_reportPossibleCrUseOfList({
        ...
        SetUpOpenMode(mode, listenerObj) {
          if (mode === void 0) {
            mode = 1;
          }
        ...
        OnClickSell() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.bagHandleType = BagHandleType.SELL;
            var confirmObj = yield (_crd && MessageBox === void 0 ? (_reportPossibleCrUseOfMessageBox({
              error: Error()
            }), MessageBox) : MessageBox).Show("确定要出售" + _this.uiBagItem.define.Name + "吗？", "出售", (_crd && MessageBoxType === void 0 ? (_reportPossibleCrUseOfMessageBoxType({
              error: Error()
        ...
        OnClickTran() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2.bagHandleType = BagHandleType.TRAN;
            _this2.confirmTranObj = yield (_crd && InputBox === void 0 ? (_reportPossibleCrUseOfInputBox({
              error: Error()
        ...
        OnClickCancelTran() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this3.bagHandleType = BagHandleType.CANCELTRAN;
            var confirmObj = yield (_crd && MessageBox === void 0 ? (_reportPossibleCrUseOfMessageBox({
              error: Error()
            }), MessageBox) : MessageBox).Show("确定要取消交易" + _this3.uiBagItem.define.Name + "吗？", "取消交易", (_crd && MessageBoxType === void 0 ? (_reportPossibleCrUseOfMessageBoxType({
              error: Error()
            }), MessageBoxType) : MessageBoxType).Confirm, "确定", "取消");
            var this_ = _this3;
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
        ...
        OnClickSelected() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), EventType) : EventType).UIBag_OnClickSelected, _this4.listenerObj, _this4.uiBagItem.define.ID);
          })();
        }
        /**
        * 背包列表渲染
        ...
        */
        ...
        OnBagListRender(node, index) {
          var uiBagItem = node.getComponent(_crd && UIBagItem === void 0 ? (_reportPossibleCrUseOfUIBagItem({
            error: Error()
          }), UIBagItem) : UIBagItem);
