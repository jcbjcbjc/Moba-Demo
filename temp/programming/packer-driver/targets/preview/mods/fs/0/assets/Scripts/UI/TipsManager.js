      ...
      _export("TipsManager", TipsManager = (_dec = ccclass('TipsManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = _class3 = class TipsManager extends Component {
        ...
        createShowNode(content) {
          try {
            ...
            var uiTips = labelNode.getComponent(_crd && UITips === void 0 ? (_reportPossibleCrUseOfUITips({
              error: Error()
            }), UITips) : UITips);
            ...
            var newNode = (_director$getScene = director.getScene()) === null || _director$getScene === void 0 ? void 0 : _director$getScene.getChildByUuid(labelNode.uuid);
        ...
        update() {
          if (this.moveTipsList.length > 0) {
            try {
              for (var i = 0; i < this.moveTipsList.length; i++) {
                var labelNode = this.moveTipsList[i];
                var uiTips = labelNode.getComponent(_crd && UITips === void 0 ? (_reportPossibleCrUseOfUITips({
                  error: Error()
                }), UITips) : UITips);
                var pos = uiTips.labelNode.position; // console.log('pos='+pos)
        ...
        showTips(str) {
          var labelNode = this.createShowNode(str);
