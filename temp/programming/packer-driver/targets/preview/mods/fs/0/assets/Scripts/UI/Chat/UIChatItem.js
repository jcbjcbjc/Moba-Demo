  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIChatItem", UIChatItem = (_dec = ccclass('UIChatItem'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec(_class = (_class2 = (_temp = class UIChatItem extends (_crd && ListViewItem === void 0 ? (_reportPossibleCrUseOfListViewItem({
        ...
        SetItemInfo(chatMessage, enterFontCount, index, chatChannel, chatMessageList) {
          var _this = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            var uiOtherMyUserItem = null;

            if (chatMessage.fromId == (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
              error: Error()
            }), User) : User).Instance.user.id) {
              _this.myUser.active = true;
              _this.otherUser.active = false;
              uiOtherMyUserItem = _this.myUser.getComponent(_crd && UIOtherMyUserItem === void 0 ? (_reportPossibleCrUseOfUIOtherMyUserItem({
                error: Error()
              }), UIOtherMyUserItem) : UIOtherMyUserItem);
            } else {
              _this.myUser.active = false;
              _this.otherUser.active = true;
              uiOtherMyUserItem = _this.otherUser.getComponent(_crd && UIOtherMyUserItem === void 0 ? (_reportPossibleCrUseOfUIOtherMyUserItem({
                error: Error()
              }), UIOtherMyUserItem) : UIOtherMyUserItem);
            }
            ...
            if (index - 1 < 0) {
              ...
              if (prevCompMessage) {
                var jgTime = chatMessage.time - prevCompMessage.time;
            ...
            if (isShowTime) {
              _this.timeNode.active = true;
              console.log('chatMessage.time=' + chatMessage.time);
              _this.timeLabel.string = new Date(parseInt(chatMessage.time)).toWeiXinString();
            }
          })();
        }
