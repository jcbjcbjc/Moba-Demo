    ...
    execute: function () {
      ...
      _export("CharacterManager", CharacterManager = class CharacterManager {
        ...
        */
        ...
        CreateCharacter(teamType2) {
          return _asyncToGenerator(function* () {
            var teamArr = (_crd && TeamType2 === void 0 ? (_reportPossibleCrUseOfTeamType({
              error: Error()
            ...
            var roomUsers = (_crd && TeamType2 === void 0 ? (_reportPossibleCrUseOfTeamType({
              error: Error()
            ...
            for (var i = 0; i < teamArr.length; i++) {
              var characterNode = teamArr[i];

              if (!roomUsers[i]) {
                return;
              }

              var cId = roomUsers[i].cCharacterId;
              ...
              var resource = characterDefine.Resource;
              ...
              var character = new (_crd && Creature === void 0 ? (_reportPossibleCrUseOfCreature({
                error: Error()
