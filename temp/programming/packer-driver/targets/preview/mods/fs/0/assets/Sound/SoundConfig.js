  ...
  return {
    ...
    execute: function () {
      ...
      _export("SoundConfig", SoundConfig = class SoundConfig {
        //音乐开关
        static get MusicOn() {
          var value = sys.localStorage.getItem("Music");
        ...
        static get SoundOn() {
          var value = sys.localStorage.getItem("Sound");
        ...
        static get MusicVolume() {
          var value = sys.localStorage.getItem("MusicVolume");
        ...
        static get SoundVolume() {
          var value = sys.localStorage.getItem("SoundVolume");
