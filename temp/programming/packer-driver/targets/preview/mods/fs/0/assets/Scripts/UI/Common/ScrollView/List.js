System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Node, Component, Enum, tween, _decorator, EventHandler, ScrollView, Prefab, Layout, Size, NodePool, isValid, instantiate, Vec3, Widget, UITransform, CCFloat, CCBoolean, CCInteger, ListItem, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _temp, _crd, ccclass, property, disallowMultiple, menu, executionOrder, requireComponent, TemplateType, SlideType, SelectedType, List;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f846bfLfbNJ6rxuwPnChs8T", "List", undefined);
      ...
      _export("default", List = (_dec = disallowMultiple(), _dec2 = menu('List'), _dec3 = requireComponent(ScrollView), _dec4 = executionOrder(-5000), _dec5 = property({
        ...
        serializable: false
      }), ccclass(_class = _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = class List extends Component {
        constructor() {
          super(...arguments);
        ...
        _processAutoScrolling(dt) {
          ...
          var a = new Vec3(sv['_autoScrollTargetDelta']);
          a.multiplyScalar(percentage);
          var newPosition = new Vec3(sv['_autoScrollStartPosition']);
          newPosition.add(a);
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "templateType", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
