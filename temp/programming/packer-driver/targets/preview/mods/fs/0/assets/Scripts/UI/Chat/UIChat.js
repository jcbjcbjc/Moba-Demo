  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIChat", UIChat = (_dec = ccclass('UIChat'), _dec2 = property(_crd && TabView === void 0 ? (_reportPossibleCrUseOfTabView({
        ...
        onLoad() {
          //初始化综合列表
          var compMessages = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
            error: Error()
          ...
          var roomMessages = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
            error: Error()
        ...
        start() {
          ...
          var chatIconArr = this.chatIconBg.children;
          var tempChatIcon = null;

          for (var i = 0; i < 63; i++) {
            var newChatIcon = null;
            ...
            var iconName = i + 1 < 10 ? '0' + (i + 1) : i + 1;
            newChatIcon.name = iconName + '';
            var sprite = newChatIcon.getComponent(Sprite);
        ...
        ChangeChatChannel(index, user) {
          ...
          if (index == 1 && user) {
            //私聊列表更新用户
            var chatUserVo = new (_crd && ChatUserVo === void 0 ? (_reportPossibleCrUseOfChatUserVo({
              error: Error()
        ...
        OnChatIconClick(param) {
          var name = param.currentTarget._name;
          console.log(name);
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this.index == 0) {
              ...
              (_crd && ChatService === void 0 ? (_reportPossibleCrUseOfChatService({
                error: Error()
              }), ChatService) : ChatService).Instance.SendChat(ChatChannel.Comp, _this.contentEditBox.string, undefined);
            } else if (_this.index == 1) {
              //私聊
              if (!_this.uiChatUserItem) {
              ...
              var chatUserVo = _this.uiChatUserItem.chatUserVo;
              (_crd && ChatService === void 0 ? (_reportPossibleCrUseOfChatService({
                error: Error()
              }), ChatService) : ChatService).Instance.SendChat(ChatChannel.Private, _this.contentEditBox.string, undefined, chatUserVo.userId, chatUserVo.nickName, chatUserVo.level, chatUserVo.cCharacterId);
            } else if (_this.index == 2) {
              //房间
              console.log('room SendChat=' + JSON.stringify((_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
                error: Error()
              }), ChatManager) : ChatManager).Instance.roomMessages) + ',index=' + _this.index);
              (_crd && ChatService === void 0 ? (_reportPossibleCrUseOfChatService({
                error: Error()
              }), ChatService) : ChatService).Instance.SendChat(ChatChannel.RoomChat, _this.contentEditBox.string, ChatRoomType.Room_);
            }
        ...
        */
        ...
        OnClickChatIcon() {
          ...
          return _asyncToGenerator(function* () {
            if (_this2.chatIconBg.active) {
              _this2.chatIconBg.active = false;
            } else {
              _this2.chatIconBg.active = true;
            }
          })();
        }
        /**
        ...
        */
        ...
        updatePrivateList() {
          var userId = this.selectedPrivateUserId;
          ...
          if (!userId) {
            ...
            if ((_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
              ...
              var chatUserVo = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
                error: Error()
          ...
          if (userId) {
            var chatMessageList = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
              error: Error()
        ...
        OnCompListRender(item, index) {
          ...
          var uiChatItem = item.getComponent(_crd && UIChatItem === void 0 ? (_reportPossibleCrUseOfUIChatItem({
            error: Error()
        ...
        OnUserListRender(item, index) {
          var uiChatUserItem = item.getComponent(_crd && UIChatUserItem === void 0 ? (_reportPossibleCrUseOfUIChatUserItem({
            error: Error()
        ...
        OnChat_UI(param) {
          ...
          if (channel == ChatChannel.Comp) {
            ...
            //私聊
            var privateMessages = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
              error: Error()
        ...
        OnPrivateUserStatusChange() {
          var chatUserVoList = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
            error: Error()
        ...
        OnChangeRedNum() {
          var privateNum = (_crd && ChatManager === void 0 ? (_reportPossibleCrUseOfChatManager({
            error: Error()
