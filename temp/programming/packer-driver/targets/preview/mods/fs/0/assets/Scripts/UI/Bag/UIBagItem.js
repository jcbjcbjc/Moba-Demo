  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIBagItem", UIBagItem = (_dec = ccclass('UIBagItem'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Sprite), _dec5 = property(SpriteFrame), _dec(_class = (_class2 = (_temp = class UIBagItem extends (_crd && ListViewItem === void 0 ? (_reportPossibleCrUseOfListViewItem({
        ...
        SetItemInfo(item, uiBagDetailItem, selected, index, uiBag) {
          var _this = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.uiBag = uiBag;
            _this.uiBagDetailItem = uiBagDetailItem;
            ...
            _this.countLabel.string = item.count + '';
            _this.tranLabel.node.active = item.isTran;
            ...
            if (selected) {
              ...
              _this.uiBagDetailItem.SetItemInfo(item);
