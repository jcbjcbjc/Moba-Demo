        ...
        update() {
          if (this.owner) {
            ...
            if (currentCharacter && this.owner.creatureType == (_crd && CreatureType === void 0 ? (_reportPossibleCrUseOfCreatureType({
              ...
              //角色
              var user = this.owner.user;
              var type = user.id == currentCharacter.user.id ? 1 : this.owner.teamType2 == currentCharacter.teamType2 ? 2 : 3;
              ...
              //怪物
              var _type = this.owner.teamType2 == currentCharacter.teamType2 ? 2 : 3;

              this.SetItemInfo(undefined, undefined, this.owner.attributes.HP, this.owner.characterDefine.HP, false, _type);
            }
          }
        }
