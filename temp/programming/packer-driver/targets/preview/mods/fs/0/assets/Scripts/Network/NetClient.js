    ...
    execute: function () {
      ...
      _export("NetClient", NetClient = class NetClient {
        ...
        onReceiveMessage(event) {
          var netMessage = NetMessage.decode(new Uint8Array(event.data));
        ...
        SendMessage(message) {
          ...
          var msg = NetMessage.encode(message).finish(); // console.log('NetClient SendMessage message='+JSON.stringify(message),msg)
