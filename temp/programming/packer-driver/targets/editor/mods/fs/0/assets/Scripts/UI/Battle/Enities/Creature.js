  ...
  return {
    ...
    execute: function () {
      ...
      _export("Creature", Creature = class Creature {
        ...
        //ai管理器
        //距离
        constructor(teamType2, node, define, user, creatureType, birthPosition = null, birthRotation = null) {
        ...
        PlayEffect(type, name, target, duration = 0) {
        ...
        PlayEffect2(type, name, position, duration = 0) {
          if (type == (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
            error: Error()
          }), EffectType) : EffectType).Position || type == (_crd && EffectType === void 0 ? (_reportPossibleCrUseOfEffectType({
            error: Error()
