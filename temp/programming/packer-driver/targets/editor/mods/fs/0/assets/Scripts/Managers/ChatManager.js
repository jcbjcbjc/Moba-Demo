    ...
    execute: function () {
      ...
      _export("ChatManager", ChatManager = class ChatManager {
        ...
        Init() {
          ...
          let privateMessagesValue = (_crd && LocalStorageUtil === void 0 ? (_reportPossibleCrUseOfLocalStorageUtil({
            error: Error()
        ...
        AddMessages(channel, messages) {
          ...
          for (let i = 0; i < messages.length; i++) {
            ...
            if (channel == ChatChannel.Private) {
              //私聊
              let userId = chatMessage.fromId != (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
                error: Error()
        ...
        */
        ...
        OnPrivateUserStatusQuery_UI(param) {
          let statusList = param[0];
          let chatUserVoList = new Array();
          ...
          for (let i = 0; i < this.userIds.length; i++) {
            ...
            if (chatMessageList && chatMessageList.length > 0) {
              let chatMessage = chatMessageList[chatMessageList.length - 1];
              let chatUserVo = null;
