    ...
    execute: function () {
      ...
      _export("UIAuction", UIAuction = (_dec = ccclass('UIAuction'), _dec2 = property(_crd && List === void 0 ? (_reportPossibleCrUseOfList({
        ...
        async OnClickOfferPrice() {
          ...
          this.confirmInputOfferPriceObj = await (_crd && InputBox === void 0 ? (_reportPossibleCrUseOfInputBox({
            error: Error()
        ...
        async OnClickAuction() {
          this.uiBag = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventType) : EventType).UIBag_OnClickSelected, this.UIBag_OnClickSelected, this);
        }
        /**
         * 背包物品选择
         * @param param 
        ...
        async UIBag_OnClickSelected(param) {
          let itemId = param[0];
          this.confirmInputCoinObj = await (_crd && InputBox === void 0 ? (_reportPossibleCrUseOfInputBox({
            error: Error()
        ...
        */
        ...
        OnAuctionListRender(node, index) {
          let uiAuctionItem = node.getComponent(_crd && UIAuctionItem === void 0 ? (_reportPossibleCrUseOfUIAuctionItem({
            error: Error()
