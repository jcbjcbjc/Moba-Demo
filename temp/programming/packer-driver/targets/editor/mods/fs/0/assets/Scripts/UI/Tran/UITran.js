    ...
    execute: function () {
      ...
      _export("UITran", UITran = (_dec = ccclass('UITran'), _dec2 = property(Prefab), _dec3 = property(_crd && ListView === void 0 ? (_reportPossibleCrUseOfListView({
        ...
        async OnClickBuy() {
          ...
          let itemDefine = this.uiTranItem.itemDefine; // let shopItemDefine=this.uiTranItem.shopItemDefine;
        ...
        async OnQueryTran_UI(param) {
          ...
          for (let i = 0; i < items.length; i++) {
            ...
            let uiTranItem = node.getComponent(_crd && UITranItem === void 0 ? (_reportPossibleCrUseOfUITranItem({
              error: Error()
            }), UITranItem) : UITranItem);
            await (uiTranItem === null || uiTranItem === void 0 ? void 0 : uiTranItem.SetItemInfo(item, this.uiTranDetailItem, i == this.selectedIndex, i, this));
            this.listMain.AddItem(node, uiTranItem);
          }
        }
