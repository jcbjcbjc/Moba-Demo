    ...
    execute: function () {
      ...
      _export("Skill", Skill = class Skill {
        ...
        StartSkill() {
          ...
          if (this.Define.AOEEffect) {
            if (this.Define.CastTarget.toString() == (_crd && TargetType === void 0 ? (_reportPossibleCrUseOfTargetType({
              ...
              {
                let renderVec3 = new Vec3(this.Context.positionX, 0, this.Context.positionZ);
        ...
        InitHitInfo(isBullet) {
          let hitInfo = new (_crd && SkillHitInfo === void 0 ? (_reportPossibleCrUseOfSkillHitInfo({
            error: Error()
        ...
        CastBullet(hitInfo, target) {
          ...
          let bullet = new (_crd && Bullet === void 0 ? (_reportPossibleCrUseOfBullet({
            error: Error()
        ...
        CalcSkillDamage(caster, target) {
          ...
          let damage = new (_crd && DamageInfo === void 0 ? (_reportPossibleCrUseOfDamageInfo({
            error: Error()
