  ...
  return {
    ...
    execute: function () {
      ...
      _export("UICharacterDetail", UICharacterDetail = (_dec = ccclass('UICharacterDetail'), _dec2 = property(Label), _dec3 = property(Sprite), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Label), _dec15 = property(Label), _dec16 = property(Label), _dec17 = property(Label), _dec18 = property(Label), _dec19 = property(Label), _dec20 = property([Sprite]), _dec21 = property(Button), _dec22 = property(Button), _dec23 = property(Button), _dec24 = property(Button), _dec25 = property(Button), _dec26 = property(Button), _dec27 = property(Button), _dec28 = property(Button), _dec29 = property(Button), _dec30 = property(Button), _dec31 = property(Button), _dec32 = property(Node), _dec33 = property(Node), _dec34 = property(Node), _dec35 = property(Node), _dec(_class = (_class2 = (_temp = class UICharacterDetail extends (_crd && UIWindow === void 0 ? (_reportPossibleCrUseOfUIWindow({
        ...
        SendCharacterDetail(userId, tCharacterId, openMode = 1) {
        ...
        async OnCharacterDetail_UI(param) {
          ...
          this.characterSprite.spriteFrame = await (_crd && LoadResUtil === void 0 ? (_reportPossibleCrUseOfLoadResUtil({
            error: Error()
          ...
          this.levelLabel.string = '等级：' + ((_user$character2 = user.character) === null || _user$character2 === void 0 ? void 0 : _user$character2.level);
          this.expLabel.string = '经验：' + ((_user$character3 = user.character) === null || _user$character3 === void 0 ? void 0 : _user$character3.exp);
          this.attLabel.string = '攻击力：' + ((_user$character4 = user.character) === null || _user$character4 === void 0 ? void 0 : _user$character4.att);
          this.attSpotLabel.string = '+' + ((_user$character5 = user.character) === null || _user$character5 === void 0 ? void 0 : _user$character5.attSpot);
          this.defLabel.string = '防御力：' + ((_user$character6 = user.character) === null || _user$character6 === void 0 ? void 0 : _user$character6.def);
          this.defSpotLabel.string = '+' + ((_user$character7 = user.character) === null || _user$character7 === void 0 ? void 0 : _user$character7.defSpot);
          this.hpLabel.string = '血量：' + ((_user$character8 = user.character) === null || _user$character8 === void 0 ? void 0 : _user$character8.hp);
          this.hpSpotLabel.string = '+' + ((_user$character9 = user.character) === null || _user$character9 === void 0 ? void 0 : _user$character9.hpSpot);
          this.criLabel.string = '暴击率：' + ((_user$character10 = user.character) === null || _user$character10 === void 0 ? void 0 : _user$character10.cri);
          this.criSpotLabel.string = '+' + ((_user$character11 = user.character) === null || _user$character11 === void 0 ? void 0 : _user$character11.criSpot);
          this.resuLabel.string = '复活率：' + ((_user$character12 = user.character) === null || _user$character12 === void 0 ? void 0 : _user$character12.resu);
          this.resuSpotLabel.string = '+' + ((_user$character13 = user.character) === null || _user$character13 === void 0 ? void 0 : _user$character13.resuSpot);
          this.speedLabel.string = '速度：提升' + ((_user$character14 = user.character) === null || _user$character14 === void 0 ? void 0 : _user$character14.speed) + "%";
          this.speedSpotLabel.string = '+' + ((_user$character15 = user.character) === null || _user$character15 === void 0 ? void 0 : _user$character15.speedSpot);
          this.cdLabel.string = 'cd：降低' + ((_user$character16 = user.character) === null || _user$character16 === void 0 ? void 0 : _user$character16.cd) + "%";
          this.cdSpotLabel.string = '+' + ((_user$character17 = user.character) === null || _user$character17 === void 0 ? void 0 : _user$character17.cdSpot);
          ...
          for (var skillId in skillMap) {
            ...
            this.skillSpriteArr[index].spriteFrame = await (_crd && LoadResUtil === void 0 ? (_reportPossibleCrUseOfLoadResUtil({
              error: Error()
        ...
        async OpenUIPromote(param, customEventData) {
          console.log(customEventData);
          let uiPromote = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
          ...
          if (customEventData == AttrPromoteType.Att) {
            ...
            spot = (_this$user$character = this.user.character) === null || _this$user$character === void 0 ? void 0 : _this$user$character.attSpot;
          } else if (customEventData == AttrPromoteType.Def) {
            var _this$user$character2;

            spot = (_this$user$character2 = this.user.character) === null || _this$user$character2 === void 0 ? void 0 : _this$user$character2.defSpot;
          } else if (customEventData == AttrPromoteType.Hp) {
            var _this$user$character3;

            spot = (_this$user$character3 = this.user.character) === null || _this$user$character3 === void 0 ? void 0 : _this$user$character3.hpSpot;
          } else if (customEventData == AttrPromoteType.Cri) {
            var _this$user$character4;

            spot = (_this$user$character4 = this.user.character) === null || _this$user$character4 === void 0 ? void 0 : _this$user$character4.criSpot;
          } else if (customEventData == AttrPromoteType.Resu) {
            var _this$user$character5;

            spot = (_this$user$character5 = this.user.character) === null || _this$user$character5 === void 0 ? void 0 : _this$user$character5.resuSpot;
          } else if (customEventData == AttrPromoteType.Speed) {
            var _this$user$character6;

            spot = (_this$user$character6 = this.user.character) === null || _this$user$character6 === void 0 ? void 0 : _this$user$character6.speedSpot;
          } else if (customEventData == AttrPromoteType.Cd) {
            var _this$user$character7;

            spot = (_this$user$character7 = this.user.character) === null || _this$user$character7 === void 0 ? void 0 : _this$user$character7.cdSpot;
          }
        ...
        async OnClickBag() {
          let uiBag = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        async OnClickTran() {
          let uiTran = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        async OnClickFollow() {
          (_crd && FollowManager === void 0 ? (_reportPossibleCrUseOfFollowManager({
            error: Error()
          }), FollowManager) : FollowManager).Instance.SendFollow(this.user.id, true);
        }
        /**
         * 点击取消关注
         */
        ...
        async OnClickCancelFollow() {
          (_crd && FollowManager === void 0 ? (_reportPossibleCrUseOfFollowManager({
            error: Error()
          }), FollowManager) : FollowManager).Instance.SendFollow(this.user.id, false);
        }
        /**
         * 关注/取消关注响应
         */
