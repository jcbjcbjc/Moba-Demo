        ...
        (function () {
          ...
          $root.FrameHandleResponse = function () {
            ...
            FrameHandleResponse.encode = function encode(message, writer) {
              ...
              if (message.frameHandles != null && message.frameHandles.length) for (var i = 0; i < message.frameHandles.length; ++i) $root.FrameHandle.encode(message.frameHandles[i], writer.uint32(
              /* id 2, wireType 2 =*/
              18).fork()).ldelim();
              return writer;
            };
            ...
            FrameHandleResponse.toObject = function toObject(message, options) {
              ...
              if (message.frameHandles && message.frameHandles.length) {
                ...
                for (var j = 0; j < message.frameHandles.length; ++j) object.frameHandles[j] = $root.FrameHandle.toObject(message.frameHandles[j], options);
              }
          ...
          $root.RepairFrameResponse = function () {
            ...
            RepairFrameResponse.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.repairFrames != null && message.repairFrames.length) for (var i = 0; i < message.repairFrames.length; ++i) $root.RepairFrame.encode(message.repairFrames[i], writer.uint32(
              /* id 1, wireType 2 =*/
              10).fork()).ldelim();
              return writer;
            };
            ...
            RepairFrameResponse.toObject = function toObject(message, options) {
              ...
              if (message.repairFrames && message.repairFrames.length) {
                ...
                for (var j = 0; j < message.repairFrames.length; ++j) object.repairFrames[j] = $root.RepairFrame.toObject(message.repairFrames[j], options);
              }
          ...
          $root.LiveFrameResponse = function () {
            ...
            LiveFrameResponse.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.liveFrames != null && message.liveFrames.length) for (var i = 0; i < message.liveFrames.length; ++i) $root.RepairFrame.encode(message.liveFrames[i], writer.uint32(
              /* id 1, wireType 2 =*/
              10).fork()).ldelim();
              return writer;
            };
            ...
            LiveFrameResponse.toObject = function toObject(message, options) {
              ...
              if (message.liveFrames && message.liveFrames.length) {
                ...
                for (var j = 0; j < message.liveFrames.length; ++j) object.liveFrames[j] = $root.RepairFrame.toObject(message.liveFrames[j], options);
              }
