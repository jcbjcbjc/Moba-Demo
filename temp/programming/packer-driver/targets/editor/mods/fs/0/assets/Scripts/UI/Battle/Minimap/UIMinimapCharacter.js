  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIMinimapCharacter", UIMinimapCharacter = (_dec = ccclass('UIMinimapCharacter'), _dec2 = property(Sprite), _dec(_class = (_class2 = (_temp = class UIMinimapCharacter extends Component {
        ...
        async SetItemInfo(character, minimapBoxVo) {
          this.character = character;
          this.minimapBoxVo = minimapBoxVo; //更换背景颜色
          ...
          this.avatarImgSprite.spriteFrame = await (_crd && LoadResUtil === void 0 ? (_reportPossibleCrUseOfLoadResUtil({
            error: Error()
        ...
        update() {
          ...
          /*&& this.isPrintResult*/
              ...
              let relaY = -(this.character.renderPosition.z - this.minimapBoxVo.z) + this.minimapBoxVo.height / 2; //获取角色在包围盒的x、y比例
