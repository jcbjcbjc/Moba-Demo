    ...
    execute: function () {
      ...
      _export("UIBattleChat", UIBattleChat = (_dec = ccclass('UIBattleChat'), _dec2 = property(_crd && TabView === void 0 ? (_reportPossibleCrUseOfTabView({
        ...
        OnChatListRender(item, index) {
          let uiBattleChatItem = item.getComponent(_crd && UIBattleChatItem === void 0 ? (_reportPossibleCrUseOfUIBattleChatItem({
            error: Error()
        ...
        async OnClickSend() {
          ...
          (_crd && ChatService === void 0 ? (_reportPossibleCrUseOfChatService({
            error: Error()
          }), ChatService) : ChatService).Instance.SendChat(ChatChannel.RoomChat, this.contentEditBox.string, this.index == 0 ? ChatRoomType.Game_ : ChatRoomType.Live_);
