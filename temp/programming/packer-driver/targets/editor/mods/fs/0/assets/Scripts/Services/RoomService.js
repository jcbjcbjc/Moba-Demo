        ...
        */
        ...
        async OnAddRoomRequest(param) {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventType) : EventType).UIMessageBox_OnClickYes, async () => {
            let teamConfirmObj = await (_crd && MessageBox === void 0 ? (_reportPossibleCrUseOfMessageBox({
              error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventType) : EventType).UIMessageBox_OnClickNo, async () => {
