    ...
    execute: function () {
      ...
      _export("UIWorldElementManager", UIWorldElementManager = (_dec = ccclass('UIWorldElementManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = _class3 = class UIWorldElementManager extends Component {
        ...
        AddCharacterHpBar(owner, creature) {
          ...
          let uiWorldElement = hpBarNode2.getComponent(_crd && UIWorldElement === void 0 ? (_reportPossibleCrUseOfUIWorldElement({
            error: Error()
          }), UIWorldElement) : UIWorldElement);
          let uiHpBar = hpBarNode2.getComponent(_crd && UIHpBar === void 0 ? (_reportPossibleCrUseOfUIHpBar({
            error: Error()
          }), UIHpBar) : UIHpBar);
        ...
        ShowPopupText(type, creature, damage, isCrit, isBuff) {
          ...
          let uiWorldElement = goPopup.getComponent(_crd && UIWorldElement === void 0 ? (_reportPossibleCrUseOfUIWorldElement({
            error: Error()
          }), UIWorldElement) : UIWorldElement);
