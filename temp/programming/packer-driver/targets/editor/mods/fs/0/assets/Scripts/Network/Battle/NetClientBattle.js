    ...
    execute: function () {
      ...
      _export("NetClientBattle", NetClientBattle = class NetClientBattle {
        ...
        onReceiveMessage(event) {
          let netMessage = NetMessageResponse2.decode(new Uint8Array(event.data)); // console.log('NetClientBattle 收到服务器消息：'+JSON.stringify(netMessage))
        ...
        SendMessage(message) {
          ...
          let msg = NetMessageRequest2.encode(message).finish(); // console.log('NetClientBattle SendMessage message='+JSON.stringify(message),msg)
