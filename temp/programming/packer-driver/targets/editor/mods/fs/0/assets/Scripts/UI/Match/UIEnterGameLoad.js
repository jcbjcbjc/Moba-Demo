    ...
    execute: function () {
      ...
      _export("UIEnterGameLoad", UIEnterGameLoad = (_dec = ccclass('UIEnterGameLoad'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Sprite), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Sprite), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Sprite), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Sprite), _dec15 = property(Label), _dec16 = property(Label), _dec17 = property(Sprite), _dec18 = property(Label), _dec19 = property(Label), _dec(_class = (_class2 = (_temp = class UIEnterGameLoad extends Component {
        ...
        async start() {
          ...
          await this.InitTeamUser((_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          ...
          let ipPortArr = (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventType) : EventType).OnPercentForward, this.OnPercentForward, this);
        ...
        async InitTeamUser(roomUserList, teamType) {
          ...
          for (let i = 0; i < roomUserList.length; i++) {
            ...
            this[avatar + (i + 1)].spriteFrame = await (_crd && LoadResUtil === void 0 ? (_reportPossibleCrUseOfLoadResUtil({
              error: Error()
        ...
        */
        ...
        UpdateTeamUserPercent(userId, percent, teamType) {
          let roomUserList = teamType == TeamType.My ? (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          ...
          for (let i = 0; i < roomUserList.length; i++) {
            let roomUser = roomUserList[i]; // console.log(roomUser.userId +'=='+ userId +'==='+ (percentName+(i+1)))
