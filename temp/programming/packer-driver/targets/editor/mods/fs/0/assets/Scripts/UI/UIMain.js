    ...
    execute: function () {
      ...
      _export("UIMain", UIMain = (_dec = ccclass('UIMain'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec(_class = (_class2 = (_temp = class UIMain extends Component {
        ...
        async start() {
          ...
          this.levelText.string = '等级：' + ((_Instance$user$charac = (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          }), User) : User).Instance.user.character) === null || _Instance$user$charac === void 0 ? void 0 : _Instance$user$charac.level);
          this.expText.string = '经验：' + ((_Instance$user$charac2 = (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          ...
          this.nicknameText.string = '昵称：' + (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          }), User) : User).Instance.user.nickname;
          this.coinText.string = '金币：' + (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          }), User) : User).Instance.user.coin;
          let cid = (_Instance$user$charac4 = (_crd && User === void 0 ? (_reportPossibleCrUseOfUser({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventType) : EventType).UserCoinChange, this.OnUserCoinChange, this);
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            error: Error()
          }), EventManager) : EventManager).Instance.addListener((_crd && EventType === void 0 ? (_reportPossibleCrUseOfEventType({
            error: Error()
        ...
        SetUpClick() {
          let obj = (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        async OnClickShop() {
          let uiShop = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        async OnClickPowerRanking() {
          let uiPowerRanking = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        async OnClickAuction() {
          let uiAuction = await (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        */
        ...
        async OnClickJoinRoom() {
          let inputBox = await (_crd && InputBox === void 0 ? (_reportPossibleCrUseOfInputBox({
            error: Error()
